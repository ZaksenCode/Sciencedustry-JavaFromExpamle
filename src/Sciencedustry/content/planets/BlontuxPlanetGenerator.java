    ...
    Block[][] arr =
            {
                    ...
                    {SCBlocks.purpleSandWater, SCBlocks.darkPurpleSandFloor, SCBlocks.darkPurpleSandFloor, SCBlocks.darkPurpleSandFloor, SCBlocks.greenMoss, SCBlocks.greenMossyStone, SCBlocks.warmSnow, SCBlocks.sacchariteFloor, SCBlocks.sacchariteFloor, SCBlocks.obsidianFloor, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor},
                    {SCBlocks.purpleSandWater, SCBlocks.darkPurpleSandFloor, SCBlocks.darkPurpleSandFloor, SCBlocks.sporeGreenMoss, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor},
                    {SCBlocks.deepRadioactiveWater, Blocks.darksandTaintedWater, SCBlocks.darkPurpleSandFloor, SCBlocks.sporeGreenMoss, SCBlocks.sporeGreenMoss, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor},
                    {SCBlocks.radioactiveWaterFloor, Blocks.darksandTaintedWater, SCBlocks.darkPurpleSandFloor, SCBlocks.sporeGreenMoss, SCBlocks.greenMossyStone, SCBlocks.sporeGreenMoss, Blocks.iceSnow, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor},
                    {SCBlocks.purpleSandWater, SCBlocks.darkPurpleSandFloor, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.warmSnow, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor, SCBlocks.obsidianFloor}
            };

    ObjectMap<Block, Block> dec = ObjectMap.of(
            SCBlocks.sporeGreenMoss, Blocks.sporeCluster,
            SCBlocks.greenMoss, Blocks.sporeCluster,
            SCBlocks.radioactiveWaterFloor, SCBlocks.radioactiveWaterFloor,
            SCBlocks.purpleSandWater, SCBlocks.purpleSandWater
    );
    ...
    protected void generate(){
        ...
        class Room{
            ...
            void joinLiquid(int x1, int y1, int x2, int y2){
                ...
                int avoid = 2 + rad;
                Seq path = pathfind(x1, y1, x2, y2, tile -> (tile.solid() || !tile.floor().isLiquid ? 70f : 0f) + noise(tile.x, tile.y, 2, 0.4f, 1f / nscl) * 500, Astar.manhattan);
                path.each(t -> {
                    //don't place liquid paths near the core
                    if(Mathf.dst2(x1, y1, x2, y2) <= avoid * avoid){
                        return;
                    }
                        ...
                        for(int y = -rad; y <= rad; y++){
                            ...
                            if(Structs.inBounds(wx, wy, width, height) && Mathf.within(x, y, rad)){
                                ...
                                if(Mathf.within(x, y, rad - 1) && !other.floor().isLiquid){
                                    ...
                                    other.setFloor((Floor)(floor == Blocks.sand || floor == Blocks.salt ? SCBlocks.purpleSandWater : SCBlocks.radioactiveWaterFloor));
                                }
                            }
                        }
                    }
        ...
        for(int i = 0; i < tlen; i++){
            ...
            if(tile.block() == Blocks.air){
                total ++;
                if(tile.floor().liquidDrop == SCLiquids.RadioactiveWater){
                    waters ++;
                }
            }
        }
        ...
        pass((x, y) -> {
            ...
            if(floor.asFloor().isLiquid && floor.asFloor().shallow){
                ...
                floor = floor == SCBlocks.radioactiveWaterFloor ? SCBlocks.radioactiveWaterFloor : SCBlocks.radioactiveWaterFloor;
            }
        });
        ...
        if(naval){
            ...
            pass((x, y) -> {
                if(floor.asFloor().isLiquid && !floor.asFloor().isDeep() && !floor.asFloor().shallow){
                    ...
                    floor = floor == SCBlocks.radioactiveWaterFloor ? SCBlocks.deepRadioactiveWater : SCBlocks.radioactiveWaterFloor;
                }
            });
        }
